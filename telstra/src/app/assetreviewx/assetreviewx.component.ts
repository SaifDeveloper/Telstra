...
@Component({
  selector: 'app-assetreviewx',
  templateUrl: './assetreviewx.component.html',
  styleUrls: ['./assetreviewx.component.css']
})
export class AssetreviewxComponent implements OnInit {
